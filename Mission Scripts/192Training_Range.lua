...
local RangeControlCommon = 250.000
...
--Range_ME01:SetInstructorRadio(RangeControlCommon)
...
fouldist_VE91CD = Range_VE91:GetFoullineDistance("RANGE_VE91_strafepit_C", "RANGE_VE91_FoulLine_CD")
...
--Range_VE91:SetInstructorRadio(RangeControlCommon)
