...
KILLBOX.threats = {
  { spawnTemplate = "kbSAM-SA-10-1",       menuText = "Activate SA-10", threatText = "SA-10" },
  { spawnTemplate = "kbSAM-SA-11-1",       menuText = "Activate SA-11", threatText = "SA-11" },
  { spawnTemplate = "kbSAM-SA-2-1",        menuText = "Activate SA-2", threatText = "SA-2" },
  { spawnTemplate = "kbSAM-SA-3-1",        menuText = "Activate SA-3", threatText = "SA-3" }, 
  { spawnTemplate = "kbSAM-SA-6-1",        menuText = "Activate SA-6", threatText = "SA-6" },
