...
BFMACM = {
  ...
  adversary = {
    menu = { -- Adversary menu
      {template = "ADV_F1CE_BLUE", menuText = "Adversary F1"},
      {template = "ADV_M2000_BLUE", menuText = "Adversary Mirage V"},
      {template = "ADV_F15_BLUE", menuText = "Adversary A4"},
      {template = "ADV_F5_BLUE", menuText = "Adversary F-5"},
      {template = "ADV_Mig21_BLUE", menuText = "Adversary Mig-21"},
      {template = "ADV_Mig29_BLUE", menuText = "Adversary Mig-29"},
      {template = "ADV_F18_BLUE", menuText = "Adversary F-18"},
      {template = "ADV_F14_BLUE", menuText = "Adversary F-14"},
      {template = "ADV_F16_BLUE", menuText = "Adversary F-16"},
    },
    ...
    if group and gid then
      ...
      if BFMACM.menuAdded[uid] == nil then
        ...
        if BFMACM.menuF10[gid] == nil then
          ...
          BFMACM.menuF10[gid] = MENU_GROUP:New(group, "ACM", ACM)
        end
